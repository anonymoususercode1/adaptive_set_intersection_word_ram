...
void runsAND(vector<xFastBinaryTrie<rankType, wordType>*> &Ts, uint64_t nTries, uint64_t &maxLevel,
...
template<typename rankType, typename wordType>
bool AND(vector<xFastBinaryTrie<rankType, wordType>*> &Ts, uint64_t nTries, uint64_t &maxLevel,
...
template<typename rankType, typename wordType>
void partialAND(vector<xFastBinaryTrie<rankType, wordType>*> &Ts, uint16_t n_tries, uint64_t max_level, uint64_t curr_level, 
...
// Rank v
template
vector<uint64_t> Intersect<rank_support_v<1>, uint64_t>(vector<xFastBinaryTrie<rank_support_v<1>, uint64_t>*> &Ts, bool runs, bool parallel);
template
vector<uint64_t> Intersect<rank_support_v<1>, uint32_t>(vector<xFastBinaryTrie<rank_support_v<1>, uint32_t>*> &Ts, bool runs, bool parallel);
template
vector<uint64_t> Intersect<rank_support_v<1>, uint16_t>(vector<xFastBinaryTrie<rank_support_v<1>, uint16_t>*> &Ts, bool runs, bool parallel);
template
vector<uint64_t> Intersect<rank_support_v<1>, uint8_t>(vector<xFastBinaryTrie<rank_support_v<1>, uint8_t>*> &Ts, bool runs, bool parallel);
// Rank v5
template
vector<uint64_t> Intersect<rank_support_v5<1>, uint64_t>(vector<xFastBinaryTrie<rank_support_v5<1>, uint64_t>*> &Ts, bool runs, bool parallel);
template
vector<uint64_t> Intersect<rank_support_v5<1>, uint32_t>(vector<xFastBinaryTrie<rank_support_v5<1>, uint32_t>*> &Ts, bool runs, bool parallel);
template
vector<uint64_t> Intersect<rank_support_v5<1>, uint16_t>(vector<xFastBinaryTrie<rank_support_v5<1>, uint16_t>*> &Ts, bool runs, bool parallel);
template
vector<uint64_t> Intersect<rank_support_v5<1>, uint8_t>(vector<xFastBinaryTrie<rank_support_v5<1>, uint8_t>*> &Ts, bool runs, bool parallel);