...
void runsAND(vector<x2WRBinaryTrie<rankType, wordType>*> &Ts, uint64_t nTries, uint64_t &maxLevel,
        ...
        while (w != 0){
            ...
            for (uint16_t j = 0; j < nTries; ++j) {
                if (activeTries[j]) {
                    ...
                    wLow &= Ts[j] -> getWordLow(roots[j], pos);
                }
            }
    ...
    if (orResult == 0b00) {
        ...
        uint64_t range = ((uint64_t)1 << ((maxLevel+(uint64_t)(log2(pow(sizeof(wordType)*8,2)))-1) - currLevel))- 1;
...
template<typename rankType, typename wordType>
bool AND(vector<x2WRBinaryTrie<rankType, wordType>*> &Ts, uint64_t nTries, uint64_t &maxLevel,
...
template<typename rankType, typename wordType>
void partialAND(vector<x2WRBinaryTrie<rankType, wordType>*> &Ts, uint16_t n_tries, uint64_t max_level, uint64_t curr_level, 
...
template<typename rankType, typename wordType>
vector<uint64_t> Intersect(vector<x2WRBinaryTrie<rankType, wordType>*> &Ts, bool runs, bool parallel){
...
// Rank v
template
vector<uint64_t> Intersect<rank_support_v<1>, uint64_t>(vector<x2WRBinaryTrie<rank_support_v<1>, uint64_t>*> &Ts, bool runs, bool parallel);
template
vector<uint64_t> Intersect<rank_support_v<1>, uint32_t>(vector<x2WRBinaryTrie<rank_support_v<1>, uint32_t>*> &Ts, bool runs, bool parallel);
template
vector<uint64_t> Intersect<rank_support_v<1>, uint16_t>(vector<x2WRBinaryTrie<rank_support_v<1>, uint16_t>*> &Ts, bool runs, bool parallel);
template
vector<uint64_t> Intersect<rank_support_v<1>, uint8_t>(vector<x2WRBinaryTrie<rank_support_v<1>, uint8_t>*> &Ts, bool runs, bool parallel);
// Rank v5
template
vector<uint64_t> Intersect<rank_support_v5<1>, uint64_t>(vector<x2WRBinaryTrie<rank_support_v5<1>, uint64_t>*> &Ts, bool runs, bool parallel);
template
vector<uint64_t> Intersect<rank_support_v5<1>, uint32_t>(vector<x2WRBinaryTrie<rank_support_v5<1>, uint32_t>*> &Ts, bool runs, bool parallel);
template
vector<uint64_t> Intersect<rank_support_v5<1>, uint16_t>(vector<x2WRBinaryTrie<rank_support_v5<1>, uint16_t>*> &Ts, bool runs, bool parallel);
template
vector<uint64_t> Intersect<rank_support_v5<1>, uint8_t>(vector<x2WRBinaryTrie<rank_support_v5<1>, uint8_t>*> &Ts, bool runs, bool parallel);