...
bool AND(vector<x3WTRBinaryTrie<rankType, wordType>*> &Ts, uint64_t nTries, uint64_t &maxLevel,
...
template<typename rankType, typename wordType>
void IntersectPartition(vector<x3WTRBinaryTrie<rankType, wordType>*> &Ts, uint64_t &nTries, uint64_t &height, vector<uint64_t> &groupTrieP, uint64_t groupTrieA[64][16], vector<uint64_t> &intersection){
...
// Rank v
template
vector<uint64_t> Intersect<rank_support_v<1>, uint64_t>(vector<x3WTRBinaryTrie<rank_support_v<1>, uint64_t>*> &Ts, bool parallel, bool balance);
template
vector<uint64_t> Intersect<rank_support_v<1>, uint32_t>(vector<x3WTRBinaryTrie<rank_support_v<1>, uint32_t>*> &Ts, bool parallel, bool balance);
template
vector<uint64_t> Intersect<rank_support_v<1>, uint16_t>(vector<x3WTRBinaryTrie<rank_support_v<1>, uint16_t>*> &Ts, bool parallel, bool balance);
template
vector<uint64_t> Intersect<rank_support_v<1>, uint8_t>(vector<x3WTRBinaryTrie<rank_support_v<1>, uint8_t>*> &Ts, bool parallel, bool balance);
// Rank v5
template
vector<uint64_t> Intersect<rank_support_v5<1>, uint64_t>(vector<x3WTRBinaryTrie<rank_support_v5<1>, uint64_t>*> &Ts, bool parallel, bool balance);
template
vector<uint64_t> Intersect<rank_support_v5<1>, uint32_t>(vector<x3WTRBinaryTrie<rank_support_v5<1>, uint32_t>*> &Ts, bool parallel, bool balance);
template
vector<uint64_t> Intersect<rank_support_v5<1>, uint16_t>(vector<x3WTRBinaryTrie<rank_support_v5<1>, uint16_t>*> &Ts, bool parallel, bool balance);
template
vector<uint64_t> Intersect<rank_support_v5<1>, uint8_t>(vector<x3WTRBinaryTrie<rank_support_v5<1>, uint8_t>*> &Ts, bool parallel, bool balance);