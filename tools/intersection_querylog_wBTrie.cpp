...
map<uint64_t, wBinaryTrie<rankType, wordType>*> loadTries(ifstream &in, vector<vector<uint64_t>> &queries, u_int64_t n){
    ...
    for(uint32_t i = 0; i < n; ++i) {
        wBinaryTrie<rankType, wordType>* trie = new wBinaryTrie<rankType, wordType>();
        trie -> load(in);
